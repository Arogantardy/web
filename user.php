<?php
// Cek apakah user yang login adalah admin atau danny
if ($_SESSION['username'] !== 'admin' && $_SESSION['username'] !== 'danny') {
    echo "
    <script>
    ...
    ";
    exit; // Hentikan eksekusi script agar konten di bawah tidak dimuat
}
?>
...
if (!empty($password)) {
    ...
    if ($nama_foto != '') {
        ...
        if ($cek_upload['status']) {
		        //jika true maka message berpassword nama file foto
            $foto = $cek_upload['message'];
        } else {
		        //jika true maka message berpassword pesan error, tampilkan dalam alert
            echo "<script>
